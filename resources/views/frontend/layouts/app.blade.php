...
<section class="welcome_area">
    <div class="welcome_slides owl-carousel">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-7 col-md-8">
                        <div class="welcome_slide_text">
                            ...
                            <a href="index-1.html#" class="btn btn-primary" data-animation="fadeInUp" data-delay="1s">Buy Now</a>
                        </div>
                    </div>
        ...
        <!-- Single Slide -->
        <div class="single_slide bg-img" style="background-image: url({{asset('frontend/img/bg-img/7.jpg')}});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-md-8">
                        <div class="welcome_slide_text">
                            ...
                            <a href="index-1.html#" class="btn btn-primary" data-animation="fadeInUp" data-delay="600ms">Check Collection</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Slide -->
        <div class="single_slide bg-img" style="background-image: url({{asset('frontend/img/bg-img/6.jpg')}});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-md-6">
                        <div class="welcome_slide_text">
                            ...
                            <a href="index-1.html#" class="btn btn-primary" data-animation="fadeInUp" data-delay="900ms">Add to cart</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="quickview_pro_des">
                                    ...
                                    <a href="index-1.html#">View Full Product Details</a>
                                </div>
                                <!-- Add to Cart Form -->
                                ...
                                <div class="share_wf mt-30">
                                    ...
                                    <div class="_icon">
                                        <a href="index-1.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                        <a href="index-1.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                        <a href="index-1.html#"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                                        <a href="index-1.html#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                        <a href="index-1.html#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                        <a href="index-1.html#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="new_arrivals_slides owl-carousel">
                    ...
                    <div class="single-product-area">
                        ...
                        <div class="product_description">
                            ...
                            <div class="product_add_to_cart">
                                <a href="index-1.html#"><i class="icofont-shopping-cart"></i> Add to Cart</a>
                            </div>

                            <!-- Quick View -->
                            <div class="product_quick_view">
                                <a href="index-1.html#" data-toggle="modal" data-target="#quickview"><i class="icofont-eye-alt"></i> Quick View</a>
                            </div>

                            <p class="brand_name">Top</p>
                            <a href="index-1.html#">Boutique Silk Dress</a>
                    ...
                    <div class="single-product-area">
                        ...
                        <div class="product_description">
                            ...
                            <a href="index-1.html#">Gracia Plaid Dress</a>
                    ...
                    <div class="single-product-area">
                        ...
                        <div class="product_description">
                            ...
                            <a href="index-1.html#">Flower Textured Dress</a>
            ...
            <div class="col-12 col-lg-6">
                <div class="featured_offer_area d-flex align-items-center" style="background-image: url({{asset('frontend/img/bg-img/fea_offer.jpg')}});">
                    <div class="featured_offer_text">
                        ...
                        <a href="index-1.html#" class="btn btn-primary btn-sm mt-3">Shop Now</a>
                    </div>
                </div>
            </div>
                ...
                <div class="featured_product_slides owl-carousel">
                    ...
                    <div class="single-product-area">
                        ...
                        <div class="product_description">
                            ...
                            <a href="index-1.html#">Box Shape Dress</a>
                    ...
                    <div class="single-product-area">
                        ...
                        <div class="product_description">
                            ...
                            <a href="index-1.html#">Black Dress</a>
            ...
            <div class="col-12">
                <div class="tabs_area">
                    ...
                    <ul class="nav nav-tabs" role="tablist" id="product-tab">
                        <li class="nav-item">
                            <a href="index-1.html#top-sellers" class="nav-link" data-toggle="tab" role="tab">Top Sellers</a>
                        </li>
                        <li class="nav-item">
                            <a href="index-1.html#best-rated" class="nav-link" data-toggle="tab" role="tab">Best Rated</a>
                        </li>
                        <li class="nav-item">
                            <a href="index-1.html#on-sale" class="nav-link active" data-toggle="tab" role="tab">On Sale</a>
                        </li>
                    </ul>
                                            ...
                                            <div class="top_seller_desc">
                                                ...
                                                <div class="ts-seller-info mt-3 d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="ts_product_add_to_cart">
                                                        <a href="index-1.html#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icofont-shopping-cart"></i></a>
                                                    </div>
                                                    ...
                                                    <div class="ts_product_quick_view">
                                                        <a href="index-1.html#" data-toggle="modal" data-target="#quickview"><i class="icofont-eye-alt"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="beach_offer_area mb-4 mb-md-0">
                    ...
                    <div class="beach_offer_info">
                        <p>Upto 70% OFF</p>
                        <h3>Beach Item</h3>
                        <a href="index-1.html#" class="btn btn-primary btn-sm mt-15">SHOP NOW</a>
                    </div>
                </div>
            </div>
                ...
                <div class="apparels_offer_area">
                    ...
                    <div class="apparels_offer_info d-flex align-items-center">
                        <div class="apparels-offer-content">
                            ...
                            <a href="index-1.html#" class="btn">Buy Now <i class="icofont-rounded-right"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                <div class="single_footer_area mb-100">
                    ...
                    <div class="footer_social_area mt-15">
                        ...
                        <a href="index-1.html#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        <a href="index-1.html#"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                        <a href="index-1.html#"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                        <a href="index-1.html#"><i class="fa fa-rss" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
                <div class="single_footer_area mb-100">
                    ...
                    <ul class="footer_widget_menu">
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Your Account</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Free Shipping Policy</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Your Cart</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Return Policy</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Free Coupon</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Delivary Info</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
                <div class="single_footer_area mb-100">
                    ...
                    <ul class="footer_widget_menu">
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Product Support</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Terms &amp; Conditions</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Help</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Payment Method</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Affiliate Program</a></li>
                        <li><a href="index-1.html#"><i class="icofont-rounded-right"></i> Privacy Policy</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-3">
                ...
                <div class="single_footer_area mb-100">
                    ...
                    <div class="apps_download">
                        <a href="index-1.html#"><img src="{{asset('frontend/img/core-img/play-store.png')}}" alt="Play Store"></a>
                        <a href="index-1.html#"><img src="{{asset('frontend/img/core-img/app-store.png')}}" alt="Apple Store"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="copywrite_text">
                        <p>Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="index-1.html#">Designing World</a></p>
                    </div>
                </div>
                <!-- Payment Method -->
                <div class="col-12 col-md-6">
