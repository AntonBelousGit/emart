                            ...
                            <div class="row h-100 align-items-center">
                                ...
                                <div class="col-5 col-md-4">
                                    <div class="welcome_slide_image">
                                        <img src="{{asset('frontend/img/bg-img/slide-1.png')}}" alt=""
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="quickview_pro_img">
                                        <img class="first_img"
                                             src="{{asset('frontend/img/product-img/new-1-back.png')}}" alt="">
                                ...
                                <div class="col-12 col-lg-7">
                                    ...
                                    <div class="share_wf mt-30">
                                        ...
                                        <div class="_icon">
                                            <a href="index-1.html#"><i class="fa fa-facebook"
                                                                       aria-hidden="true"></i></a>
                                            <a href="index-1.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                            <a href="index-1.html#"><i class="fa fa-pinterest"
                                                                       aria-hidden="true"></i></a>
                                            <a href="index-1.html#"><i class="fa fa-linkedin"
                                                                       aria-hidden="true"></i></a>
                                            <a href="index-1.html#"><i class="fa fa-instagram"
                                                                       aria-hidden="true"></i></a>
                    ...
                    <div class="new_arrivals_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{asset('frontend/img/product-img/new-1-back.png')}}"
                                     alt="">
                            ...
                            <div class="product_description">
                                ...
                                <div class="product_quick_view">
                                    <a href="index-1.html#" data-toggle="modal" data-target="#quickview"><i
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                ...
                                <img class="hover_img" src="{{asset('frontend/img/product-img/new-6-back.png')}}"
                                     alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                ...
                                <img class="hover_img" src="{{asset('frontend/img/product-img/new-2-back.png')}}"
                                     alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                ...
                                <img class="hover_img" src="{{asset('frontend/img/product-img/new-4-back.png')}}"
                                     alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                ...
                                <img class="hover_img" src="{{asset('frontend/img/product-img/new-5-back.png')}}"
                                     alt="">
                    ...
                    <div class="featured_product_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                ...
                                <img class="hover_img" src="{{asset('frontend/img/product-img/new-7-back.png')}}"
                                     alt="">
                ...
                <div class="col-12">
                    <div class="tabs_area">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="product-tab">
                            <li class="nav-item">
                                <a href="index-1.html#top-sellers" class="nav-link" data-toggle="tab" role="tab">Top
                                    Sellers</a>
                            </li>
                            <li class="nav-item">
                                <a href="index-1.html#best-rated" class="nav-link" data-toggle="tab" role="tab">Best
                                    Rated</a>
                            </li>
                            <li class="nav-item">
                                <a href="index-1.html#on-sale" class="nav-link active" data-toggle="tab" role="tab">On
                                    Sale</a>
                            </li>
                        </ul>
                                ...
                                <div class="top_sellers_area">
                                    <div class="row">
                                                ...
                                                <div class="top_seller_desc">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="ts_product_add_to_cart">
                                                            <a href="index-1.html#" data-toggle="tooltip"
                                                        ...
                                                        <div class="ts_product_quick_view">
                                                            <a href="index-1.html#" data-toggle="modal"
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/top-2.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Beach Cap</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/top-3.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Gold Neckless</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/top-4.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/top-5.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Shoes</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/top-6.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Pin Up Bikini</h5>
                                ...
                                <div class="best_rated_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/best-1.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sports Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/best-2.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/best-3.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Women Watch</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/best-5.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Plus Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="{{asset('frontend/img/product-img/best-6.png')}}"
                                                         alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Laptop</h5>
                            ...
                            <div class="elect_offer_area mt-30 mt-lg-0">
                                ...
                                <div class="elect_offer_info d-flex align-items-center">
                                    <div class="elect-offer-content">
                                        <h4>Electronics</h4>
                                        <a href="index-1.html#" class="btn">Buy Now <i
