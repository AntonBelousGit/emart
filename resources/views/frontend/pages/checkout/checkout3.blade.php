...
{{--                                                   data-parent="#accordion" href="checkout-4.html#collapse_one"--}}
{{--                                                   aria-expanded="false" aria-controls="collapse_one"><i--}}
{{--                                                        class="icofont-mastercard-alt"></i> Pay with Credit Card</a>--}}
{{--                                            </h6>--}}
{{--                                        </div>--}}
{{--                                        <div aria-expanded="false" id="collapse_one"--}}
{{--                                             class="panel-collapse collapse show" role="tabpanel" aria-labelledby="one">--}}
...
{{--                                                                           for="customCheck1">Credit or Debit--}}
{{--                                                                        Card</label>--}}
{{--                                                                </div>--}}
{{--                                                            </div>--}}
...
{{--                                                                    payment info is stored securely. <a--}}
{{--                                                                        href="checkout-4.html#">Learn More</a></small>--}}
{{--                                                            </div>--}}
...
{{--                                                            </div>--}}
{{--                                                            <div class="col-12 col-md-3 mb-3">--}}
{{--                                                                <label for="security_code">Security Code <a--}}
{{--                                                                        href="checkout-4.html#"--}}
{{--                                                                        class="security_code_popover"--}}
{{--                                                                        data-container="body" data-toggle="popover"--}}
{{--                                                                        data-placement="top" data-content=""--}}
{{--                                                                        data-img="img/bg-img/cvc.jpg"> <i--}}
...
{{--                                            <h6 class="panel-title">--}}
{{--                                                <a class="collapsed" role="button" data-toggle="collapse"--}}
{{--                                                   data-parent="#accordion" href="checkout-4.html#collapse_two"--}}
{{--                                                   aria-expanded="false" aria-controls="collapse_two"><i--}}
{{--                                                        class="icofont-paypal-alt"></i> Pay with PayPal</a>--}}
{{--                                            </h6>--}}
{{--                                        </div>--}}
...
{{--                                                                    Secure online payments at the speed of want. <a--}}
{{--                                                                        href="checkout-4.html#">Learn More</a></small>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="col-12 col-md-6 mb-3">--}}
...
{{--                                                                       class="form-text text-muted"><a--}}
{{--                                                                        href="checkout-4.html#">Forget--}}
{{--                                                                        Password?</a></small>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="col-12">--}}
{{--                                                                <button type="submit" class="btn btn-primary">Submit--}}
...
{{--                                            <h6 class="panel-title">--}}
{{--                                                <a class="collapsed" role="button" data-toggle="collapse"--}}
{{--                                                   data-parent="#accordion" href="checkout-4.html#collapse_three"--}}
{{--                                                   aria-expanded="false" aria-controls="collapse_three"><i--}}
{{--                                                        class="icofont-bank-transfer-alt"></i> Direct Bank Transfer</a>--}}
{{--                                            </h6>--}}
{{--                                        </div>--}}
{{--                                        <div aria-expanded="false" id="collapse_three"--}}
{{--                                             class="panel-collapse collapse in" role="tabpanel" aria-labelledby="three">--}}
{{--                                            <div class="panel-body">--}}
...
{{--                                            <h6 class="panel-title">--}}
{{--                                                <a class="collapsed" role="button" data-toggle="collapse"--}}
{{--                                                   data-parent="#accordion" href="checkout-4.html#collapse_four"--}}
{{--                                                   aria-expanded="false" aria-controls="collapse_four"><i--}}
{{--                                                        class="icofont-file-document"></i> Cheque Payment--}}
{{--                                                </a>--}}
{{--                                            </h6>--}}
{{--                                        </div>--}}
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="five">
                                            <h6 class="panel-title">
                                                <div class="col-12 mb-3">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="payment_method" value="cod" class="custom-control-input"
                                                               id="customCheck2">
                                                        <label class="custom-control-label fix-label-five"
                                                               for="customCheck2"><i
                                                                class="icofont-cash-on-delivery-alt"></i> Cash on
                                                            Delivery</label>
                                                    </div>
                                                </div>
                                                {{--                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="checkout-4.html#collapse_five" aria-expanded="false" aria-controls="collapse_five"><i class="icofont-cash-on-delivery-alt"></i> Cash on Delivery--}}
                                                {{--                                            </a>--}}
                                            </h6>
                                        </div>
