    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="index.html"><img src="images/logo.svg" alt="Lucid Logo" class="img-responsive logo"></a>
            </div>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu">
                            <li class="active">
                                <a href="index3.html#Dashboard" class="has-arrow"><i class="icon-home"></i> <span>Dashboard</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#App" class="has-arrow"><i class="icon-grid"></i> <span>App</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#FileManager" class="has-arrow"><i class="icon-folder"></i> <span>File Manager</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#Blog" class="has-arrow"><i class="icon-globe"></i> <span>Blog</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#uiElements" class="has-arrow"><i class="icon-diamond"></i> <span>UI Elements</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#Widgets" class="has-arrow"><i class="icon-puzzle"></i> <span>Widgets</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#Authentication" class="has-arrow"><i class="icon-lock"></i> <span>Authentication</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#Pages" class="has-arrow"><i class="icon-docs"></i> <span>Pages</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#forms" class="has-arrow"><i class="icon-pencil"></i> <span>Forms</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#Tables" class="has-arrow"><i class="icon-tag"></i> <span>Tables</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#charts" class="has-arrow"><i class="icon-bar-chart"></i> <span>Charts</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#Maps" class="has-arrow"><i class="icon-map"></i> <span>Maps</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="index3.html#menu-level-1" class="has-arrow"><i class="icon-tag"></i> <span>Menu Level 1</span></a>
                                <ul>
                                    <li>
                                        <a href="index3.html#menu-level-2" class="has-arrow">Menu Level 2</a>
                                        <ul>
                                            <li><a href="index3.html#">Link 1</a></li>
                                            <li><a href="index3.html#">Link 2</a></li>
                                            <li><a href="index3.html#">Link 3</a></li>
                                            <li><a href="index3.html#">Link 4</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
