                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Delivery Time" name="delivery_time" required value="{{$shipping->delivery_time}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <select name="status" class="form-control show-tick" required>
                                            ...
                                            <option value="inactive" {{$shipping->status === 'inactive' ? 'selected': ''}}>
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
