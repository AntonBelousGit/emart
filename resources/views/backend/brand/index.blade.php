        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                    class="fa fa-arrow-left"></i></a>Brands</h2>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right  btn-align-midl">
                        <div class="inlineblock text-center m-r-15 m-l-15  btn-align-midl">
                               <a href="{{route('brand.create')}}" class="btn btn-round btn-primary"><i class="icon-plus"></i> Create Brand</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <span>Total count: {{$brand_count}}</span>
                        </div>
                        <div class="body">
